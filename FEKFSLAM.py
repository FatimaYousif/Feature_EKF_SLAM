...
class FEKFSLAM(FEKFMBL):
    ...
    def Localize(self, xk_1, Pk_1):
        ...
        # xk, Pk = self.AddNewFeatures(xk_bar,Pk_bar,znp,Rnp)         # part1 without updates
        
        if len(znp) > 0:
            xk, Pk = self.AddNewFeatures(xk,Pk,znp,Rnp)         # part2 with updates
